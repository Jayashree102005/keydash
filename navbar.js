 ...
 <h1 class="text-2xl text-slate-900 font-bold tracking-tight">
    ...
    <div class="flex items-center gap-3">
      ...
      <div id="rightButtons" class="hidden lg:flex items-center gap-4">
        ...
        <a href="login.html"
          class="px-5 py-2.5 rounded-xl border-2 border-transparent bg-[#F59E0B] text-white text-sm font-bold hover:bg-[#D97706] shadow-md transition duration-200">
          Login
        </a>
...
<div id="mobileMenu"
  ...
  <div class="flex items-center justify-between p-5 border-b border-slate-100">
    <h2 class="text-xl font-bold flex items-center gap-2.5">
      <span class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-[#F59E0B]">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="none" class="w-4.5 h-4.5">
          <circle cx="11" cy="11" r="5.5" stroke="white" stroke-width="2.2" fill="none"/>
          <line x1="15.5" y1="11" x2="27" y2="11" stroke="white" stroke-width="2.2" stroke-linecap="round"/>
          <line x1="24" y1="11" x2="24" y2="16" stroke="white" stroke-width="1.8" stroke-linecap="round"/>
          <line x1="20" y1="11" x2="20" y2="15" stroke="white" stroke-width="1.8" stroke-linecap="round"/>
  ...
  <div class="p-6 overflow-y-auto font-medium">
    ...
    <div class="mt-6 pt-6 border-t border-slate-100">
      ...
      <div class="flex flex-col gap-3 mb-6">
        ...
        <a href="login.html" class="w-full text-center py-3 rounded-xl border-2 border-transparent bg-[#F59E0B] text-white text-sm font-bold hover:bg-[#D97706] shadow-md transition duration-200">
          Login
        </a>
      </div>
